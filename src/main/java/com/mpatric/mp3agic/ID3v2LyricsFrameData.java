...
public class ID3v2LyricsFrameData extends AbstractID3v2FrameData {
	...
	public ID3v2LyricsFrameData(boolean unsynchronisation, String encoding, String language, EncodedText description, EncodedText lyrics) {
		super(unsynchronisation);
	...
	protected void unpackFrameData(byte[] bytes) throws InvalidDataException {
        ...
        // get the lyrics from the bytes array
        ...
        lyrics = new EncodedText(lyricsString);
	}
	...
	public void setLyrics(EncodedText lyrics) {
		this.lyrics = lyrics;
	}
